...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi, welcome to a space where technology meets curiosity—join me as I explore the limitless possibilities of code and its intersection with everything around us. 🎉',
//===============
  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'JackX', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '实践者，逐心客。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://blog.jackxfan.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'blog,博客,jackxfan,jack fan', // 网站关键词 英文逗号隔开
  ...
  //   ********挂件组件相关********
  // AI 文章摘要生成 @see https://docs_s.tianli0.top/  //TODO:自己搞🤔
  TianliGPT_CSS:
  ...
  // Chatbase 是否显示chatbase机器人 https://www.chatbase.co/ //TODO: 另一个JackX
